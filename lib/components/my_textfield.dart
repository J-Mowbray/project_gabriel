...
/// MyTextfield provides a standardised text input component used throughout the app.
///
...
/// password obscuring, error messages, and specialised keyboard types.
class MyTextfield extends StatelessWidget {
  ...
  /// Creates a standardised text field with consistent styling.
  ///
  /// Parameters:
  ...
  ///   keyboardType - Optional specialised keyboard layout (email, number, etc.)
  const MyTextfield({
    super.key,
